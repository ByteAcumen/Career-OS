...
// ΓöÇΓöÇΓöÇ LaTeX Renderer ΓÇö Jake's Resume Style (Overleaf-ready, ATS-safe) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function renderResumeLatex(input: {
  ...
  const parts: string[] = [
    "%--------------------------",
    "% Career OS ΓÇö Resume",
    "% Jake's Resume Style ΓÇö paste into Overleaf and compile with pdfLaTeX",
    "%--------------------------",
